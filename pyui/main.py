...
class Ui_CommentLikerPanel(object):
    def setupUi(self, CommentLikerPanel):
        ...
        CommentLikerPanel.resize(583, 314)
        ...
        self.commentBox.setGeometry(QtCore.QRect(320, 10, 251, 211))
        ...
        self.commentsList.setGeometry(QtCore.QRect(10, 30, 231, 171))
        ...
        self.getComments.setGeometry(QtCore.QRect(420, 240, 151, 25))
        self.getComments.setObjectName("getComments")
        self.comment = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.comment.setGeometry(QtCore.QRect(9, 10, 301, 211))
        ...
        self.terminal.setGeometry(QtCore.QRect(10, 80, 288, 121))
        self.terminal.setObjectName("terminal")
        self.startLike = QtWidgets.QPushButton(parent=self.centralwidget)
        self.startLike.setGeometry(QtCore.QRect(10, 240, 151, 25))
