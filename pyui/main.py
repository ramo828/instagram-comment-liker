...
class Ui_CommentLikerPanel(object):
    def setupUi(self, CommentLikerPanel):
        ...
        CommentLikerPanel.resize(731, 376)
        ...
        self.commentBox.setGeometry(QtCore.QRect(320, 10, 391, 281))
...
"border-radius: 15px;")
        ...
        self.getComments.setGeometry(QtCore.QRect(560, 301, 151, 25))
        ...
        self.like_count.setGeometry(QtCore.QRect(236, 224, 61, 21))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(13, 224, 131, 17))
        self.label_2.setObjectName("label_2")
        self.error_count = QtWidgets.QSpinBox(parent=self.comment)
        self.error_count.setEnabled(False)
        self.error_count.setGeometry(QtCore.QRect(236, 249, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.error_count.setFont(font)
        self.error_count.setMaximum(9999)
        self.error_count.setObjectName("error_count")
        self.label_3 = QtWidgets.QLabel(parent=self.comment)
        self.label_3.setGeometry(QtCore.QRect(13, 251, 131, 17))
        self.label_3.setObjectName("label_3")
        self.startLike = QtWidgets.QPushButton(parent=self.centralwidget)
        self.startLike.setEnabled(False)
        self.startLike.setGeometry(QtCore.QRect(10, 301, 151, 25))
    ...
    def retranslateUi(self, CommentLikerPanel):
        ...
        self.label_2.setText(_translate("CommentLikerPanel", "Beğenenler: "))
        self.label_3.setText(_translate("CommentLikerPanel", "Beğenmeyenler:"))
